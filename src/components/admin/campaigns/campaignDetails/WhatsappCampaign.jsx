...
const WhatsappCampaign = () => {
  ...
  return (
    <div className="overflow-y-auto min-h-screen w-full px-2 py-2 md:gap-4 space-y-3">
      {
        ...
        <form action="" className=" space-y-3">
          <div className=" flex flex-col gap-2 rounded">
            ...
            <div className="flex w-[100%] md:flex-row flex-col" >
              ...
              <div className="flex justify-center gap-x-2 w-[40%] items-center">
                <Link
                ...
                rounded-md text-white font-semibold text-[15px] font-poppins not-italic leading-normal px-3 py-2"
                >
                  Create Template
                </Link>
