...
const Finalize = ({ campaignType }) => {
  ...
  return (
    <div className="flex flex-col justify-between h-full">
      <div className=" grid grid-cols-2 sm:grid-cols-3 gap-2">
        {
          ...
          (<div
            ...
            className={`relative flex items-center w-full justify-between flex-col gap-3 bg-blue-100 px-3 py-5 cursor-pointer border border-gray-700 rounded-md group transition-all duration-300 overflow-hidden`}
          >
      ...
      <h1 className=" font-bold text-xl text-center">Finalize</h1>
    </div>
  );
};
