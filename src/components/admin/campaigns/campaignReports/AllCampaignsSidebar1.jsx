...
const AllCampaignsSidebar = ({ data, refreshData, countData }) => {
    ...
    useEffect(() => {
        ...
        let allSortedData = [];
        try {
            allData = smsCampaignData.concat(whatsappCampaignData);
    ...
    return (
        <>
            <div className="flex lg:flex-row flex-col bg-gray-50 shadow-md rounded-md gap-4">
                <div className='flex w-full lg:w-1/3 flex-col bg-white rounded-md border border-solid'>
                ...
                { sortedData.length !== 0 && (<div className="lg:w-2/3 w-full">
                    <div>
                        {selectedCampaign &&
                ...
                {
                    (sortedData.length === 0) && (
                        <div className="lg:w-2/3 w-full md:min-h-[130vh] h-fit bg-white" >
                            <CustomNoCampaignDataComponenet/>
                        </div>
                    )
                }
