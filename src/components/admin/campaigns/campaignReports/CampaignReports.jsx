...
const CampaignReports = ({ data }) => {
    ...
    const allReport = insideSmsCampaigns.concat(insideWhatsAppCampaign);
    ...
    const rowClickHandler = async (rowData) => {
        ...
        const response = await axios.post("https://p3.kcptl.in/clicks", {
            shortIds: allRowIds,
        });
    ...
    const selectAllRows = async () => {
        ...
        const response = await axios.post("https://p3.kcptl.in/campaign/clicks", {
            shortIds: allRowIds,
        });
                        ...
                        <InsideRoutes links={links} onChange={ChangeInside}>
                            ...
                            <div name="message">
                                <div className="rounded-lg w-full mx-auto">
                                    <div className="bg-gray-600 p-2 text-white font-semibold text-[15px] rounded-t-md">
                                        Contacts
                                    </div>
