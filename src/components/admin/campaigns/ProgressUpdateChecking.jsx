...
const ProgressUpdateChecking = () => {
    ...
    const handleProgressCheck = async () => {
        // const response = await axios.post("https://p3.kcptl.in/docs/createSamplePdf", {
        ...
        // if (response.status === 200) {
            ...
            setTimeout(()=>{
                setInterval(async () => {
                    const response1 = await axios.post("https://p3.kcptl.in/docs/getProgressSampleMerging", {
                        campaignName: campaignDetails.name,
                    });
