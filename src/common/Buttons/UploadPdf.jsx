...
const UploadPdf = ({ onClick=function(){} }) => {
    ...
    return <Button className={`text-white capitalize font-poppins not-italic leading-normal text-[15px] flex justify-center items-center gap-x-2 ${active ? "bg-green-600": "bg-slate-600"} font-medium py-2 h-fit px-4`} onClick={()=> {
        setActive(!active);
        if(active){
